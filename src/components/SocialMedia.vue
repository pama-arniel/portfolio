...
<span class="inline-flex">
    <a class="footer-icon text-gray-700">
        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
            <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
        </svg>
    </a>
    <a class="footer-icon ml-4 text-gray-700">
        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
            <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
        </svg>
    </a>
    <a :href="gitlab" target="_blank" class="footer-icon ml-3 text-gray-700">
        <svg fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5 ionicon" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
            <title>Gitlab</title>
    ...
    <a :href="github" target="_blank" class="footer-icon ml-4 text-gray-700">
        <svg fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5 ionicon" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
            <title>Github</title>
    ...
    <a :href="linkedIn" target="_blank" class="footer-icon ml-3 text-gray-700">
...
export default {
  ...
  data() {
    return {
        facebook: '',
        gitlab: 'https://gitlab.com/jose.nuvensis',
        github: 'https://github.com/pama-arniel',
        linkedIn: 'https://www.linkedin.com/in/jose-arniel-pama-149bb214a/'
    };
  },
}
</script>
